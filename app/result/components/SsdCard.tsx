...
export default function SsdCard({ ssdTop }: Props) {
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-slate-900/70 p-6 text-slate-100 shadow-md">
      <h2 className="mb-4 text-lg font-semibold text-slate-400">💾 SSD 추천 TOP 3</h2>
        ...
        <div className="flex-1">
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-400">{best.readSpeed.toLocaleString()} MB/s</p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-400">{best.writeSpeed.toLocaleString()} MB/s</p>
            </div>
          </div>
